...
const mockIcons = {CheckCircle: mockIcon};
...
describe('SearchUIUtils', () => {
    ...
    describe('Test getListItem', () => {
        ...
        it('should return TransactionGroupListItem when type is EXPENSE-REPORT', () => {
            expect(SearchUIUtils.getListItem(CONST.SEARCH.DATA_TYPES.EXPENSE_REPORT, CONST.SEARCH.STATUS.EXPENSE.ALL)).toStrictEqual(TransactionGroupListItem);
        });
    ...
    describe('Test createTypeMenuItems', () => {
        it('should return the default menu items', () => {
            const menuItems = SearchUIUtils.createTypeMenuSections(undefined, undefined, {}, undefined, {}, undefined, {}, false, undefined, true, false, mockIcons)
        ...
        it('should show saved section when there are saved searches', () => {
            ...
            const sections = SearchUIUtils.createTypeMenuSections(adminEmail, adminAccountID, {}, undefined, {}, undefined, mockSavedSearches, false, undefined, true, false, mockIcons);
        ...
        it('should not show todo section when user has no appropriate permissions', () => {
            ...
            const sections = SearchUIUtils.createTypeMenuSections(adminEmail, adminAccountID, {}, undefined, mockPolicies, undefined, {}, false, undefined, true, false, mockIcons);
