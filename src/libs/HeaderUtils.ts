...
function getPinMenuItem(report: OnyxReport, icons: {Pin: IconAsset}): ThreeDotsMenuItem {
...
function getShareMenuItem(report: OnyxReport, icons: {QrCode: IconAsset}, backTo?: string): ThreeDotsMenuItem {
    return {
        icon: icons.QrCode,
