...
export default function useSearchTypeMenu(queryJSON: SearchQueryJSON) {
    ...
    const expensifyIcons = useMemoizedLazyExpensifyIcons(['Bookmark', 'Checkmark', 'Trashcan'] as const);
    ...
    const getOverflowMenu = useCallback(
        (itemName: string, itemHash: number, itemQuery: string) => getOverflowMenuUtil(itemName, itemHash, itemQuery, showDeleteModal, {Trashcan: expensifyIcons.Trashcan}, true, closeMenu),
        [showDeleteModal, closeMenu, expensifyIcons.Trashcan],
    );
