...
type BasePromotedActions = typeof CONST.PROMOTED_ACTIONS.JOIN;

type PinIcons = {Pin: IconAsset};
type ShareIcons = {QrCode: IconAsset};

type PromotedActionsType = Record<BasePromotedActions, (report: OnyxReport) => PromotedAction> & {
    [CONST.PROMOTED_ACTIONS.PIN]: (report: OnyxReport, icons: PinIcons) => PromotedAction;
    [CONST.PROMOTED_ACTIONS.SHARE]: (report: OnyxReport, icons: ShareIcons, backTo?: string) => PromotedAction;
} & {
